  ...
  return (
    <main className="min-h-screen bg-white">
        ...
        <div className="relative h-48 w-full bg-gray-900 sm:h-64 overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1544148103-0773bf10d330?q=80&w=2940&auto=format&fit=crop')] bg-cover bg-center" />
